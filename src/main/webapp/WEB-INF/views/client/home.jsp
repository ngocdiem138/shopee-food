...
<head>
    ...
    <title>Đặt Đồ Ăn Trực Tuyến Ở 16 Tỉnh Thanh Phố Trên Toàn Quốc & Giao Hàng tận nơi | Đặt Món & Giao ship tận nơi | shopeefood.vn</title>
...
<div id="app">
    <div class="wrapper">
                ...
                <div class="main-right-home" id="main-right-home">
                    ...
                    <div class="now-list-restaurant deal-tab">
                        ...
                        <div class="list-restaurant">
                            ...
                            <div class="item-restaurant">
                                <a target="_blank" class="item-content" href="/dong-nai/big-c-tan-hiep">
                                    <div class="img-restaurant">
                                        <img src="https://images.foody.vn/res/g112/1114302/prof/s280x175/image-77473f1f-220312103455.jpg" class="">
                                    </div>
                                    <div class="info-restaurant">
                                        <div class="info-basic-res">
                                            <h4 class="name-res" title="Big C - Tân Hiệp">Big C - Tân Hiệp</h4>
                                            <div class="address-res" title="Tầng 1 Và Tầng 2 Trung Tâm Thương Mại Big C Tân Hiệp, 1135 Nguyễn Ái Quốc, P. Tân Hiệp, Tp. Biên Hòa, Đồng Nai">Tầng 1 Và Tầng 2 Trung Tâm Thương Mại Big C Tân Hiệp, 1135 Nguyễn Ái Quốc, P. Tân Hiệp, Tp. Biên Hòa, Đồng Nai</div>
                                        </div>
                                        ...
                                        <div class="opentime-status">
                                            <span class="stt online" title="Mở cửa" style="color: rgb(35, 152, 57); background-color: rgb(35, 152, 57);"></span>
                                        </div>
                                    </div>
                                </a>
                            </div>
                            <div class="item-restaurant">
                                <a target="_blank" class="item-content" href="/dong-nai/trai-cay-rau-cu-qua-hat-dinh-duong-f48">
                                    <div class="img-restaurant">
                                        <img src="https://images.foody.vn/res/g112/1114302/prof/s280x175/image-77473f1f-220312103455.jpg" class="">
                                    ...
                                    <div class="info-restaurant">
                                        <div class="info-basic-res">
                                            <h4 class="name-res" title="Trái Cây &amp; Rau Củ Quả - Hạt Dinh Dưỡng F48">Trái Cây &amp; Rau Củ Quả - Hạt Dinh Dưỡng F48</h4>
                                            <div class="address-res" title="5c Tổ 44 Nguyễn Ái Quốc Khu Phố 6, P. Trung Dũng, Tp. Biên Hòa, Đồng Nai">5c Tổ 44 Nguyễn Ái Quốc Khu Phố 6, P. Trung Dũng, Tp. Biên Hòa, Đồng Nai</div>
                                        </div>
                                        <p class="content-promotion">
                                            <i class="fas fa-tag"></i>
                                            Flash Sale
                            ...
                            <div class="item-restaurant">
                                <a target="_blank" class="item-content" href="/dong-nai/thuc-pham-dinh-duong-trai-cay-rau-cu-gia-binh-on-khu-pho-6">
                                    <div class="img-restaurant">
                                        <img src="https://images.foody.vn/res/g112/1114302/prof/s280x175/image-77473f1f-220312103455.jpg" class="">
                                    </div>
                                    <div class="info-restaurant">
                                        <div class="info-basic-res">
                                            <h4 class="name-res" title="Thực Phẩm Dinh Dưỡng - Trái Cây &amp; Rau Củ Giá Bình Ổn - Khu Phố 6">Thực Phẩm Dinh Dưỡng - Trái Cây &amp; Rau Củ Giá Bình Ổn - Khu Phố 6</h4>
                                            <div class="address-res" title="3B Khu Phố 6, P. Trung Dũng, Tp. Biên Hòa, Đồng Nai">3B Khu Phố 6, P. Trung Dũng, Tp. Biên Hòa, Đồng Nai</div>
                                        </div>
                                        <p class="content-promotion">
                                            <i class="fas fa-tag"></i>
                                            Giảm món
                    ...
                    <div class="now-list-restaurant deal-tab collection collection-tab">
                        ...
                        <div class="list-restaurant">
                            ...
                            <div>
                                <div class="item-restaurant">
                                    <a target="_blank" class="item-content" title="Chợ online - Sale Đỉnh giảm 99k" href="/bo-suu-tap/cho-online---sale-dinh-giam-99k">
                                        <div class="img-restaurant">
                                            <img src="https://images.foody.vn/delivery/collection/s320x200/image-6edd98d0-211206222900.png" class="">
                                        </div>
                                        <div class="info-restaurant info-basic-res">
                                            <h4 class="name-res" title="Chợ online - Sale Đỉnh giảm 99k">Chợ online - Sale Đỉnh giảm 99k</h4>
                            ...
                            <div class="item-restaurant">
                                <a class="item-content" href="/thuong-hieu/vinachao-chao-dinh-duong">
                                    <div class="row no-gutters">
                                        <div class="col-auto">
                                            <div class="img-restaurant">
                                                <img src="https://images.foody.vn/res/g105/1045870/prof/s280x175/image-d13349c1-210115153911.jpeg" class="">
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="info-restaurant">
        ...
        <div class="container" id="container">
            ...
            <div class="now-container-coporation img-right">
                ...
                <div class="bg-corporation">
                    <img src="/asset/img/banner-phone-reg-merchant.png" alt="NowMerchant App" title="NowMerchant App" width="294px">
                </div>
            </div>
            <div class="now-container-coporation img-right">
                <h4 class="title">
                ...
                <span>
						...
						<p>
							...
							<br>Đăng ký tham gia
							<a href="https://shopeefood.vn/tuyen-dung" style="color: #4D77A2; font-weight:bold">tại đây</a>
							hoặc gửi Email qua
                ...
                <div class="bg-corporation">
                    <img src="/asset/img/bg-deliverynow-dat-mon-truc-tuyen-giao-hang-tan-noi.png" class="bg-deliverynow" alt="bg-deliverynow-dat-mon-truc-tuyen-giao-hang-tan-noi" title="bg-deliverynow-dat-mon-truc-tuyen-giao-hang-tan-noi" width="170px" data-change-lang="" style="width: 170px;">
                </div>
            </div>
            <hr>
        </div>
        ...
        <div class="modal fade modal-alert" id="cancelOderConfirm" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-noti" role="document"><div class="modal-content"><span class="close" data-dismiss="modal">x</span><div class="modal-header txt-bold font13"><span class="txt-red">srebranding.ervice_by_now</span> Thông báo</div><div class="modal-body"><p class="font15"><span>Bạn muốn hủy đơn hàng này ?</span></p></div><div class="modal-footer content-right"><button type="button" class="btn btn-red" data-dismiss="modal">Không, cám ơn</button><button type="button" class="btn btn-gray" data-dismiss="modal">Ok</button></div></div></div>
        </div>

        <div class="modal fade modal-alert" id="modal-payment-succes" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-noti" role="document"><div class="modal-content"><span class="close" data-dismiss="modal">x</span><div class="modal-header txt-bold font13"><span class="txt-red">Now</span> Thông báo</div><div class="modal-body"><div class="col col-12"><p class="font15"></p></div></div><div class="modal-footer content-right"><div class="col"><sup class="txt-red txt-bold">* </sup>Xin vui lòng kiểm tra đơn hàng của bạn trước khi nhận.</div><a href="/lich-su-dat-mon" class="btn btn-none-bg">Xem lịch sử đặt món</a><button type="button" class="btn btn-red" data-dismiss="modal">Ok</button></div></div></div>
        </div>
        ...
        <div id="topcontrol" class="topcontrol active">
            <div class="fd-back-top">
                ...
                <a class="control-link" href="https://itunes.apple.com/us/app/deliverynow/id1137866760" target="_blank" rel="noopener noreferrer">
                    <i class="fab fa-apple"></i>
                    <label>Tải ứng dụng iOs</label>
                </a>
                <a class="control-link" href="https://play.google.com/store/apps/details?id=com.deliverynow" target="_blank" rel="noopener noreferrer">
